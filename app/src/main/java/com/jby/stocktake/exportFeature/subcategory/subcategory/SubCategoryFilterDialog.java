...
public class SubCategoryFilterDialog extends DialogFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    View rootView;
    ...
    public SubCategoryFilterDialog() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.activity_sub_catgory_filter_dialog, container);
        objectInitialize();
        objectSetting();
        return rootView;
    }
    ...
    public void objectSetting(){
        ...
        importSubCategoryFilterDialogAllCheckBox.setOnCheckedChangeListener(this);
        importSubCategoryFilterDialogMoreCheckBox.setOnCheckedChangeListener(this);
        importSubCategoryFilterDialogLessCheckBox.setOnCheckedChangeListener(this);
        importSubCategoryFilterDialogBalanceCheckBox.setOnCheckedChangeListener(this);
    }
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        switch (compoundButton.getId()){
            case R.id.activity_import_sub_category_filter_dialog_all_checkbox:
                importSubCategoryFilterDialogCallBack.filter("all");
                break;
            case R.id.activity_import_sub_category_filter_dialog_more_checkbox:
                importSubCategoryFilterDialogCallBack.filter("more");
                break;
            case R.id.activity_import_sub_category_filter_dialog_less_checkbox:
                importSubCategoryFilterDialogCallBack.filter("less");
                break;
            case R.id.activity_import_sub_category_filter_dialog_balance_checkbox:
                importSubCategoryFilterDialogCallBack.filter("balance");
                break;
        }
        dismiss();
    }
