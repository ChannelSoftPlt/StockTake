...
public class ImportSubCategoryExistedDialog extends DialogFragment implements View.OnClickListener,
    ...
    ImportExistedDialogCallBack importExistedDialogCallBack;
    ...
    public ImportSubCategoryExistedDialog() {
    }
    ...
    private void objectInitialize() {
        ...
        importExistedDialogCallBack = (ImportExistedDialogCallBack) getActivity();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.fragment_category_insert_dialog_button_ignore:
                importExistedDialogCallBack.setCount();
                importExistedDialogCallBack.insertSubCategoryItem(barCode, quantity);
                dismiss();
                break;

            case R.id.fragment_category_insert_dialog_button_take_action:
                importExistedDialogCallBack.takeActionDialog(barCode, quantity, categoryID);
                break;
    ...
    public interface ImportExistedDialogCallBack {
