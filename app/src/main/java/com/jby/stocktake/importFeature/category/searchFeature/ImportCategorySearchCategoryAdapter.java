...
public class ImportCategorySearchCategoryAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ImportCategorySearchCategoryObject> categoryListViewArrayList;
    private CategoryAdapterCallBack categoryAdapterCallBack;
    private SparseBooleanArray mSelectedItemsIds;

    public ImportCategorySearchCategoryAdapter(Context context, ArrayList<ImportCategorySearchCategoryObject> categoryListViewArrayList, CategoryAdapterCallBack categoryAdapterCallBack)
    {
    ...
    @Override
    public ImportCategorySearchCategoryObject getItem(int i) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ImportCategorySearchCategoryObject object = getItem(i);
