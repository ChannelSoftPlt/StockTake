...
public class ImportCategoryUpdateDialog extends DialogFragment implements View.OnClickListener {
    View rootView;
    ...
    ImportUpdateDialogCallBack importUpdateDialogCallBack;
    String category_id, category_name, fromDialog;

    public ImportCategoryUpdateDialog() {
    }
    ...
    public void objectSetting(){
        ...
        if (mArgs != null) {
            ...
            if(fromDialog != null){
                if(fromDialog.equals("import"))
                    importUpdateDialogCallBack = (ImportUpdateDialogCallBack) getTargetFragment();
            }
            else
                importUpdateDialogCallBack = (ImportUpdateDialogCallBack) getActivity();
        ...
        switch (view.getId()){
            ...
            case R.id.fragment_category_update_dialog_button_ok:
                if(!categoryUpdateDialogEditTextCategory.getText().toString().equals("")){
                    importUpdateDialogCallBack.updateCategoryItem(categoryUpdateDialogEditTextCategory.getText().toString(), category_id);
                    closeKeyBoard();
                    dismiss();
                }
                else{
    ...
    public interface ImportUpdateDialogCallBack {
