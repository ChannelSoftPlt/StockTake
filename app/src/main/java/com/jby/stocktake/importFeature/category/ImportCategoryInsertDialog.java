...
public class ImportCategoryInsertDialog extends DialogFragment implements View.OnClickListener {
    View rootView;
    ...
    public ImportCategoryInsertDialog() {
    }
        ...
        switch (view.getId()){
            ...
            case R.id.fragment_category_insert_dialog_button_ok:
                if(!categoryInsertDialogEditTextCategory.getText().toString().equals("")){
                    importCreateDialogCallBack.createNewCategoryItem(categoryInsertDialogEditTextCategory.getText().toString());
                    closeKeyBoard();
                    dismiss();
                }
                else
