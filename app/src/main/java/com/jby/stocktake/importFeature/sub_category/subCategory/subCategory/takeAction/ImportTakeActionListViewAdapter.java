...
public class ImportTakeActionListViewAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ImportTakeActionObject> takeActionObjectArrayList;
    private int position = -1;

    ImportTakeActionListViewAdapter(Context context, ArrayList<ImportTakeActionObject> takeActionObjectArrayList)
    {
    ...
    @Override
    public ImportTakeActionObject getItem(int i) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ImportTakeActionObject object = getItem(i);
